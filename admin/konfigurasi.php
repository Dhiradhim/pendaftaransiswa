									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="status_ppdb.php">
										<div class="item form-group">
											...
											<div class="col-md-2 col-sm-6 ">
												<select class="form-control" name="status_ppdb">
												<option <?php if( $row['status_ppdb']=='0'){echo "selected"; } ?> value="0">Tutup</option>
												<option <?php if( $row['status_ppdb']=='1'){echo "selected"; } ?> value="1">Buka</option>
												</select>
											</div>
										</div>
										<div class="item form-group">
